        ...
        const countDown = new Date(birthday).getTime(),
            x = setInterval(function() {    
              ...
              if (distance < 0) {
                ...
                document.getElementById("countdown,countdown2").style.display = "none";
    ...
    var tfcountDown2 = function () {
        ...
        const countDown = new Date(birthday).getTime(),
            x = setInterval(function() {    
              ...
              document.getElementById("days2","days3").innerText = Math.floor(distance / (day)),
                document.getElementById("hours2","hours3").innerText = Math.floor((distance % (day)) / (hour)),
                document.getElementById("minutes2","minutes3").innerText = Math.floor((distance % (hour)) / (minute)),
                document.getElementById("seconds2","seconds3").innerText = Math.floor((distance % (minute)) / second);
